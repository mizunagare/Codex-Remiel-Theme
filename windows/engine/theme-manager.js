(() => {
  ...
  const seraph = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.1 14.1 8l5.8-2.2-3.6 5.1 5.6 2.5-6.1.5.8 6.1-4.6-4.1L7.4 20l.8-6.1-6.1-.5 5.6-2.5-3.6-5.1L9.9 8 12 2.1Z" fill="#fff4fb" stroke="#c7a9ff" stroke-width=".85" stroke-linejoin="round"/><path d="m12 6.3 2.2 4.1 4.5 1.6-4.5 1.6-2.2 4.1-2.2-4.1L5.3 12l4.5-1.6L12 6.3Z" fill="#ef5f9f" stroke="#7f56ba" stroke-width=".8"/><circle cx="12" cy="12" r="1.45" fill="#fff"/></svg>`;
  const palette = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.5A9.5 9.5 0 0 0 2.5 12c0 5.2 4.1 9.5 9.2 9.5 1.7 0 2.6-1 2.6-2.1 0-.8-.4-1.3-.4-2 0-1.1.9-2 2-2h1.5c2.5 0 4.1-1.8 4.1-4.1C21.5 6.4 17.2 2.5 12 2.5Z" fill="#342139" stroke="#c7a9ff"/><circle cx="8" cy="8" r="1.4" fill="#e84f92"/><circle cx="12.6" cy="6.5" r="1.4" fill="#fff4fb"/><circle cx="16.7" cy="9.1" r="1.4" fill="#9b73d5"/><circle cx="7" cy="13" r="1.4" fill="#f3a6ca"/></svg>`;
  const css = `
    ...
    #${PANEL_ID} .dtm-status{display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid color-mix(in srgb,var(--dream-manager-accent,#e84f92) 35%,transparent);border-radius:999px;background:color-mix(in srgb,var(--dream-manager-accent,#e84f92) 9%,transparent);font-size:12px;white-space:nowrap}
    #${PANEL_ID} .dtm-dot{width:7px;height:7px;border-radius:50%;background:var(--dream-manager-accent,#e84f92);box-shadow:0 0 10px var(--dream-manager-accent,#e84f92)}
    ...
    #${PANEL_ID} .dtm-button:hover{border-color:var(--dream-manager-accent,#e84f92);background:color-mix(in srgb,var(--dream-manager-accent,#e84f92) 12%,var(--main-surface-secondary,#2a1d2f))}
    ...
    #${PANEL_ID} input:focus{border-color:var(--dream-manager-accent,#e84f92);box-shadow:0 0 0 2px color-mix(in srgb,var(--dream-manager-accent,#e84f92) 18%,transparent)}
